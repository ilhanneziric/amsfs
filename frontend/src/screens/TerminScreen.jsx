...
const TerminScreen = () => {
    ...
    useEffect(async () => {
        const result = await axios(`https://amsfs.vercel.app/api/termin/dan/${params.danid}`);
    ...
    useEffect(async() => {
        for (let i = 0; i < ztermini.length; i++) {
            ...
            const resultt = await axios(`https://amsfs.vercel.app/api/tretman/${ztermini[i].tretman}`);
